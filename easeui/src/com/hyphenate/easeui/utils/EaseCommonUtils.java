...
public class EaseCommonUtils {
    ...
    public static void setAppUserInitialLetter(UserBean userAvatar) {
        final String DefaultLetter = "#";
        String letter = DefaultLetter;
        ...
        if (!TextUtils.isEmpty(userAvatar.getMUserNick())) {
            letter = new GetInitialLetter().getLetter(userAvatar.getMUserNick());
            userAvatar.setInitialLetter(letter);
            return;
        }
        if (letter.equals(DefaultLetter) && !TextUtils.isEmpty(userAvatar.getMUserName())) {
            letter = new GetInitialLetter().getLetter(userAvatar.getMUserName());
        }
        userAvatar.setInitialLetter(letter);
    }
}
