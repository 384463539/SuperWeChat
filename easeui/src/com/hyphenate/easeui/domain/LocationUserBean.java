...
public class LocationUserBean extends UserBean implements Serializable{
	...
	public LocationUserBean(String muserName, String muserNick, Integer mavatarId, String mavatarPath, String mavatarSuffix,
	...
	public String toString() {
		return "LocationUserBean [mlocationId=" + mlocationId + ", mlocationLatitude=" + mlocationLatitude
