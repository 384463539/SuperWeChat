...
public class UserBean implements Serializable {
    ...
    public UserBean(String muserName) {
        this.muserName = muserName;
    }

    public UserBean(String muserName, String muserNick,
...
//	}
    ...
    public String toString() {
        return "UserBean [muserName=" + muserName + ", muserNick=" + muserNick + ", mavatarId=" + mavatarId
                + ", mavatarPath=" + mavatarPath + ", mavatarSuffix=" + mavatarSuffix + ", mavatarType=" + mavatarType
                + ", mavatarLastUpdateTime=" + mavatarLastUpdateTime + "]";
    }

    public String getAvatar() {
        String path = "http://101.251.196.90:8000/SuperWeChatServerV2.0/downloadAvatar?name_or_hxid=" + getMUserName() + "&avatarType=user_avatar&m_avatar_suffix=" + getMUserNick();
        return path;
    }
}
