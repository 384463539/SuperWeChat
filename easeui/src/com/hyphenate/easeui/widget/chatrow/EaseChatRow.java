...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if (message.direct() == Direct.SEND) {
            EaseUserUtils.setUserAvatar2(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
        } else {
            EaseUserUtils.setUserAvatar2(context, message.getFrom(), userAvatarView);
            EaseUserUtils.setUserNick2(message.getFrom(), usernickView);
        }
