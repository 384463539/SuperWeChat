...
public class EaseContactList extends RelativeLayout {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                if(adapter != null){
                	adapter.clear();
                	adapter.addAll(new ArrayList<UserBean>(contactList));
     ...
     * init view
     */
    public void init(List<UserBean> contactList){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<UserBean>(contactList));
