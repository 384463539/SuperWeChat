...
public class EaseContactAdapter extends ArrayAdapter<UserBean> implements SectionIndexer {
    private static final String TAG = "ContactAdapter";
    List<String> list;
    List<UserBean> userList;
    List<UserBean> copyUserList;
    ...
    public EaseContactAdapter(Context context, int resource, List<UserBean> objects) {
    ...
    protected class MyFilter extends Filter {
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<UserBean>) results.values);
